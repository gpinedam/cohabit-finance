...
from app.api import auth, expenses, goals, recurring, reports, settlements, users, wishlist
...
# Serve user avatars and wishlist photos from persistent storage
app.mount("/avatars", StaticFiles(directory=str(AVATARS_DIR)), name="avatars")
app.mount("/wishlist-photos", StaticFiles(directory=str(WISHLIST_DIR)), name="wishlist-photos")
